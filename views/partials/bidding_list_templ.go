...
func BiddingList(vm types.BiddingIndexViewModel) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<div id=\"bidding-table\" class=\"flex flex-col w-full overflow-x-auto md:overflow-hidden\"><div class=\"min-w-[1200px] w-full\"><table class=\"mt-5 table table-zebra\"><thead class=\"text-base uppercase bg-base-300\"><tr><th>#</th><th>Associado</th><th>Veículo</th><th>Serviços/Peças</th><th>Data de criação</th><th>Status</th><th>Ações</th></tr></thead> <tbody class=\"text-base\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		for i, bidding := range vm.Biddings {
			...
			var templ_7745c5c3_Var9 templ.SafeURL = templ.URL(fmt.Sprintf("/orcamentos/visualizar/%d", bidding.ID))
			...
			var templ_7745c5c3_Var10 templ.SafeURL = templ.URL(fmt.Sprintf("/orcamentos/editar/%d", bidding.ID))
