...
func (r *autoOfferR) GetUser() *User {
	if r == nil {
		return nil
	}
	return r.User
...
var (
	autoOfferAllColumns            = []string{"id", "bidding_id", "user_id", "offer_details", "offer_date", "created_at", "updated_at"}
	autoOfferColumnsWithoutDefault = []string{"bidding_id", "user_id"}
...
func (o *AutoOffer) User(mods ...qm.QueryMod) userQuery {
	queryMods := []qm.QueryMod{
...
// loaded structs of the objects. This is for an N-1 relationship.
func (autoOfferL) LoadUser(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAutoOffer interface{}, mods queries.Applicator) error {
	var slice []*AutoOffer
	var object *AutoOffer
...
// SetUser of the autoOffer to the related item.
// Sets o.R.User to related.
// Adds o to related.R.AutoOffers.
func (o *AutoOffer) SetUser(ctx context.Context, exec boil.ContextExecutor, insert bool, related *User) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
